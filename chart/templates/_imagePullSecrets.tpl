...
*/}}
{{- define "omar-mapproxy.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-mapproxy.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-mapproxy.generateImagePullSecret" }}
